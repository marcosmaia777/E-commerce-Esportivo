let pizzaJson = [
    {id:1, name:'Tenis Lekes', img:'imagens/tenislekes.png', price:20.19, sizes:['100g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
